...
### Assemble into a Test & Page Object

**CRITICAL RULE: DO NOT use inline locators in the test file.** Always encapsulate the generated UI actions inside a Page Object Model (POM) to adhere to the Triad Architecture. 

```typescript
// 1. Create the Page Object: login.page.ts
...
```typescript
// 2. Write the test: login.spec.ts
import { test, expect } from './fixtures'; // Use your custom fixtures!
