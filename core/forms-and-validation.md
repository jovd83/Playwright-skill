...
test('successful form submission shows confirmation', async ({ page }) => {
  ...
  // MANDATORY: Always assert the success toast or message.
  // Just seeing a redirect or background data change is NOT enough.
  await expect(page.getByText('Message sent successfully').or(
